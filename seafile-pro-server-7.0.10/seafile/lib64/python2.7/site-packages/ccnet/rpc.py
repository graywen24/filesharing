...
class CcnetThreadedRpcClient(RpcClientBase):
    ...
    def update_role_emailuser(self, email, role, is_manual_set):
        pass
    ...
    @searpc_func("objlist", ["int", "int"])
    def get_ldap_users(self, start, limit):
        pass

    @searpc_func("int", ["int"])
    def del_ldap_user(self, user_id):
        pass

    @searpc_func("int", ["int", "string", "string", "int", "int", "string"])
    def update_ldap_user(self, user_id, email, password, is_staff, is_active, extra_attrs):
        pass

    @searpc_func("int", ["string", "string", "int", "int", "string"])
    def add_ldap_user(self, email, password, is_staff, is_active, extra_attrs):
        pass
    ...
    def add_group_dn_pair(self, group_id, dn):
        pass

    @searpc_func("objlist", [])
    def get_group_dn_pairs(self):
        pass
